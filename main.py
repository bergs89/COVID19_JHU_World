...
plotly_world_map(cumulative_positive, locations='Country', z='Total_Cases', title='Reported Covid-19 Cases', col_bar_title='Reported Covid-19 Cases', figname='world-maps/world_positive_map.html')
plotly_world_map(cumulative_death, locations='Country', z='Total_Cases', title='Reported Covid-19 Death', col_bar_title='Reported Covid-19 Death', figname='world-maps/world_death_map.html')
plotly_world_map(cumulative_recovered, locations='Country', z='Total_Cases', title='Reported Covid-19 Recovered', col_bar_title='Reported Covid-19 Recovered', figname='world-maps/world_recovered_map.html')